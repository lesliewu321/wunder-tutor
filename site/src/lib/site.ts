// One place for facts the whole site repeats.
export const SITE = {
  name: 'Wunder Tutor',
  url: 'https://wundertutor.com',
  appUrl: 'https://app.wundertutor.com',
  /** Needs a real mailbox before launch — e.g. Cloudflare Email Routing forwarding to a personal inbox. */
