    ...
    return (
      <div className="screen onboard">
        <div className="onboard__body">
          ...
          <p className="hint">These come back in lessons and the Lab until they’re easy.</p>
        </div>
        <div className="onboard__dock"><Button size="lg" block onClick={() => nav('/', { replace: true })}>Start learning</Button></div>
      </div>
    );
  }
