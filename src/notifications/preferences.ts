...
export const useReminders = create<ReminderState>()(persist(set => ({
  ...
  prefs: { days: [1, 3, 5], time: '18:00', quietStart: '20:00', quietEnd: '08:00', timezone: deviceTimezone(), locale: 'en', courses: ['en', 'zh', 'ja', 'ko', 'fr', 'es'], weekly: false, pauseUntil: 0, skipDay: '' },
  set: patch => set(patch),
