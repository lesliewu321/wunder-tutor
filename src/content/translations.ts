...
export const TRANSLATIONS: Record<string, T> = {
  'it-can-i-have-some-water-please': {
    es: '¿Me das un poco de agua, por favor?', zh: '请给我一些水，好吗？', de: 'Kann ich bitte etwas Wasser haben?', fr: 'Je peux avoir de l’eau, s’il vous plaît ?',
  ...
  'it-thank-you-very-much': {
    es: 'Muchas gracias.', zh: '非常感谢。', de: 'Vielen Dank.', fr: 'Merci beaucoup.', pt: 'Muito obrigado.', ja: 'どうもありがとうございます。', ko: '정말 감사합니다.', hi: 'बहुत-बहुत धन्यवाद।', ar: 'شكراً جزيلاً.',
  },
  'it-i-would-like-a-cup-of-hot-chocolate': {
    es: 'Quisiera una taza de chocolate caliente.', zh: '我想要一杯热巧克力。', de: 'Ich hätte gern eine Tasse heiße Schokolade.', fr: 'Je voudrais une tasse de chocolat chaud.',
  ...
  'it-could-i-have-the-menu-please': {
    es: '¿Me trae el menú, por favor?', zh: '请给我菜单，好吗？', de: 'Könnte ich bitte die Speisekarte haben?', fr: 'Pourrais-je avoir le menu, s’il vous plaît ?',
  ...
  'it-what-do-you-recommend': {
    es: '¿Qué me recomienda?', zh: '你推荐什么？', de: 'Was empfehlen Sie?', fr: 'Que recommandez-vous ?', pt: 'O que você recomenda?', ja: 'おすすめは何ですか？', ko: '무엇을 추천하시나요?', hi: 'आप क्या सुझाव देंगे?', ar: 'بماذا تنصح؟',
  },
  'it-that-sounds-great-thank-you': {
    es: 'Suena genial, gracias.', zh: '听起来很棒，谢谢。', de: 'Das klingt super, danke.', fr: 'Ça a l’air super, merci.', pt: 'Parece ótimo, obrigado.', ja: 'いいですね、ありがとう。', ko: '좋아요, 감사합니다.', hi: 'यह बढ़िया लगता है, धन्यवाद।', ar: 'يبدو رائعاً، شكراً لك.',
  },
};
